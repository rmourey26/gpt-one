...
<>
 ...
 <div className="mt-10 w-full md:w-96 md:max-w-full mx-auto">
  ...
  <p className="text-xs mt-2">Please check the box below to opt-in and allow us to include ypur personal health data stored by Google Fit and Samsung Health</p>   
             ...
             <p> This is an AccessToken generated by a custom NextAuth configuration that prompts the user to give persmission for the app to view their personal health data. This token is different for every user. Selecting the box will trigger a separate API call along with this access token to the Google Fit API . Head to the {''}
