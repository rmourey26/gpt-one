...
<>
 ...
 <div className="mt-10 w-full md:w-96 md:max-w-full mx-auto">
  ...
  <p className="text-xs mt-2">Please check to personal health data opt-in</p>   
             ...
             <p> This is an AccessToken generated by the apps authentication system and is required to render health scopes. This token is different for every user. To test that it works, sign out and sign back in and you will see a different access token. Selecting the box will trigger a separate api call along wih this access token to the Google FitNess API . To see the Fitness query and data please see the "fitnessai" page.  </p>
