...
<>
 ...
 <div className="mt-10 w-full md:w-96 md:max-w-full mx-auto">
  ...
  <p className="mb-6 text-justify mt-2 text-sm"> We pass the info below to OpenAIs Completion API using gpt-3.5-turbo-instruct which then returns the most appropriate plans from the ACA Marketplace, UHone.com,and Aetna.com.
 </p>
...
<div className="mb-6">
  ...
  <button type="submit" className="text-white bg-gradient-to-r from-violet-500 to-sky-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-violet-300 dark:focus:ring-violet-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Submit</button>
</form>
{loading && (
