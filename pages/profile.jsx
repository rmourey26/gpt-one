...
<div className={styles.center}>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
             ...
             <h2> Blood Glucose .. {session.user.me.blood_glucose} ..<br /></h2>
             <h2> Blood Pressure .. {session.user.me.blood_pressure} ..<br /></h2>
             <h2> Activity .. {session.user.me.activity} ..<br /></h2>
             <h2> Body .. {session.user.me.body} ..<br /></h2>
