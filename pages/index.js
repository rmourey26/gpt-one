...
export default function Home() {
  ...
  const [messages, setMessages] = useState([
    {role: "assistant", content: "Hi, there! Simply type in your healthcare scenario and I will provide the guidance you need! Here's an example scenario - I'm a 39 year old male with a 37 year old wife, 2 children ages 4 and 2, budget of $600 per month, no diseases or disabilities, need prescription coverage, want to save with healthy lifestyle choices. One long sentence will do, don't worry about precise grammar :-)"}
    ]);
            ...
            {messages.map((message, index) => {
              return (
                ...
                <div key={index} className={message.role === "user" && loading && index === messages.length - 1 ? styles.usermessagewaiting : message.role === "assistant" ? styles.apimessage : styles.usermessage}>
                  ...
                  {message.role === "assistant" ? <Image src="/logo.png" alt="AI" width="30" height="30" className={styles.boticon} priority={true} /> : <Image src="/usericon.png" alt="Me" width="30" height="30" className={styles.usericon} priority={true} />}
