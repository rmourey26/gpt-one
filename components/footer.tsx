...
const [loading, setLoading] = useState(true)
  ...
  const [match_type, setMatch_Type] = useState<string | "">("")
  const [program_name, setProgram_Name] = useState<string | "">("")
  const [program_description, setProgram_Description] = useState<string | "">("")
  const [match_frequency, setMatch_Frequency] = useState<string | "">("")
  const [owner_id, setOwner_Id] = useState<string | "">("")
  const [organization_name, setOrganization_Name] = useState<string | null>(null)
  const [organization_id, setOrganization_Id] = useState<string | null>(null)
...
<footer aria-label="Site Footer" className="bg-transparent">
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
    ...
    <div
      className="mt-16 mb-16 border-t border-gray-100 pt-6 sm:flex sm:items-center sm:justify-between"
    >
