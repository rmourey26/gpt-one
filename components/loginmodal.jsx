...
export default function LoginModal() {
  ...
  <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white"> Hearti
          
      </a>
    <Image className="w-8 h-8 mr-2" src="https://quantumone.b-cdn.net/flippa/hearty1.svg" alt="logo" width={320} height={113}/>
