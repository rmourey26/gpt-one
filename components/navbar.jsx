                     ...
                     {navigation.map((item) => (
                        <a
                          ...
                          className={classNames(
                            item.current ? 'bg-sky-600 text-white' : 'text-gray-300 hover:bg-sky-700 hover:text-white',
...
/>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="flex rounded-full bg-sky-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-sky-800">
