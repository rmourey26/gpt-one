...
<>
 ...
 <div className="mt-10 w-full md:w-96 md:max-w-full mx-auto">
  ...
  <p className="text-xs mt-2">Please check the box below to opt-in and allow us to include ypur personal health data stored by Google Fit and Samsung Health</p>   
        ...
        <label id="remember" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree to submit my device data and our <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a>.</label>
    </div>
  </div>
  </div>
