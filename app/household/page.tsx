...
return(
  ...
  <p className="text-center mt-2 text-sm">This form demonstrates an API call to the ACA Marketplace API. If you receive an error message on submit, it means updates are in progress.</p>
      <form onSubmit={handleSubmit}>
        ...
        <div>
            <label id="first_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">First name</label>
            <input type="text" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John" required />
           </div>
           <div>
            <label id="last_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last name</label>

            <input type="text" id="last_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Doe" required />
        </div>
        <div>
            <label id="income" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">income</label>
        ...
        <div>
            <label id="age" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">age </label>
        ...
        <div>
            <label id="gender" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">gender</label>
        ...
        <div>
            <label id="uses_tobacco" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tobacco User</label>
            <input type="text" id="uses_tobacco" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="no" required />
        </div>
    
    <div className="mb-6">
        <label id="market" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Individual | Group</label>
    ...
    <div className="mb-6">
        <label id="state" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">State</label>
    ...
    <div className="mb-6">
        <label id="zipcode" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Zipcode</label>
    ...
    <div className="mb-6">
        <label id="year" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Year</label>
    ...
    <div className="flex items-start mb-6">
        ...
        <label id="remember" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a>.</label>
    </div>
