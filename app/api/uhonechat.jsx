...
// global message context - not currently used but can be in the future
global.messages = [
  {
    role: "system",
...
export default async function(req, res) {
  ...
  const completion = await openai.createChatCompletion({
    ...
    model: "gpt-3.5-turbo",
    messages: [{ "role": "system", "content": "You provide the most appropriate uhone.com health plan based upon the users age, gender, marital status, number of children, income, budget, medical coverage needs, chronic diseases and conditions, preferred providers. You never ask the customer to upload or provide any photos as our website has no means of doing so at this time. Also, do not mention that you are a bot." }].concat(req.body.messages),
  });
